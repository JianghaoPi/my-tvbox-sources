...
<!-- STATUS-START -->
> 自动更新于 2026-09-25 02:48（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-25 02:57：上游 4/4 可用，产出 **382** 频道 / **729** 条有效地址（原始 1802，测速剔除失效 1073）。 手动触发：Actions → update → Run workflow。
