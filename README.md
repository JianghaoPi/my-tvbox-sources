...
<!-- STATUS-START -->
> 自动更新于 2026-09-12 15:32（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-12 15:40：上游 4/4 可用，产出 **389** 频道 / **738** 条有效地址（原始 1800，测速剔除失效 1062）。 手动触发：Actions → update → Run workflow。
