...
<!-- STATUS-START -->
> 自动更新于 2026-09-12 09:49（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
| 讴歌 | 📦 缓存兜底 | - | 12 | tv.nxog.top/m/: JSON 解析失败: Expecting ',' delimiter: line 9 column 72 (char 59... |
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-12 09:54：上游 4/4 可用，产出 **388** 频道 / **726** 条有效地址（原始 1800，测速剔除失效 1074）。 手动触发：Actions → update → Run workflow。
