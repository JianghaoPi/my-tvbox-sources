...
<!-- STATUS-START -->
> 自动更新于 2026-09-17 02:38（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
| 讴歌 | 📦 缓存兜底 | - | 12 | tv.nxog.top/m/: HTTP 404; 欧歌.v.nxog.top/m/: ConnectionError; 欧歌zp8.v.nxog.top... |
| 摸鱼 | ❌ | - | 0 | 我不是.摸鱼儿.top: ConnectionError; 我不是.摸鱼儿.com: 返回 HTML 页（挑战页或失效页, 6988B）; 我不是.摸鱼儿... |
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-17 02:46：上游 4/4 可用，产出 **394** 频道 / **743** 条有效地址（原始 1801，测速剔除失效 1058）。 手动触发：Actions → update → Run workflow。
