...
<!-- STATUS-START -->
> 自动更新于 2026-09-23 02:29（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-23 02:38：上游 4/4 可用，产出 **386** 频道 / **718** 条有效地址（原始 1802，测速剔除失效 1084）。 手动触发：Actions → update → Run workflow。
