...
<!-- STATUS-START -->
> 自动更新于 2026-09-24 02:48（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
| 摸鱼 | ❌ | - | 0 | 我不是.摸鱼儿.top: 返回 HTML 页（挑战页或失效页, 101410B）; 我不是.摸鱼儿.com: 返回 HTML 页（挑战页或失效页, 699... |
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-24 02:56：上游 4/4 可用，产出 **395** 频道 / **744** 条有效地址（原始 1802，测速剔除失效 1058）。 手动触发：Actions → update → Run workflow。
