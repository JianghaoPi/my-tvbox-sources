...
<!-- STATUS-START -->
> 自动更新于 2026-09-16 02:40（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-16 02:48：上游 4/4 可用，产出 **394** 频道 / **742** 条有效地址（原始 1801，测速剔除失效 1059）。 手动触发：Actions → update → Run workflow。
