...
<!-- STATUS-START -->
> 自动更新于 2026-09-16 16:10（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-16 16:18：上游 4/4 可用，产出 **396** 频道 / **746** 条有效地址（原始 1801，测速剔除失效 1055）。 手动触发：Actions → update → Run workflow。
