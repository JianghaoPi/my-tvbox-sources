...
<!-- STATUS-START -->
> 自动更新于 2026-09-19 15:44（5/12 源可用）。 手动触发：Actions → update → Run workflow。
...
| 摸鱼 | ❌ | - | 0 | 我不是.摸鱼儿.top: 返回 HTML 页（挑战页或失效页, 101391B）; 我不是.摸鱼儿.com: 返回 HTML 页（挑战页或失效页, 699... |
...
<!-- LIVE-START -->
> 直播源自动更新于 2026-09-19 15:52：上游 4/4 可用，产出 **388** 频道 / **736** 条有效地址（原始 1802，测速剔除失效 1066）。 手动触发：Actions → update → Run workflow。
